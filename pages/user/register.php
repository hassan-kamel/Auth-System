...
<body>
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            ...
            <form action="<?php echo URL?>controllers/user/registerHandler.php" method="POST"
                enctype="multipart/form-data" class="mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl">
                ...
                <p class="text-center text-sm text-gray-500">
                    Have account?
                    <a class="underline" href="<?php echo URL?>pages/user/login.php">Sign in</a>
                </p>
            </form>
